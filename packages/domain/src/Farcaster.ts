...
import { Context, pipe, Schema } from "effect"
...
export class Farcaster extends Context.Tag("Farcaster")<
  Farcaster,
  {
    ...
    getFriends: (fid: Fid) => Effect.Effect<Array<Fid>, HubError>
    getFollowers: (fid: Fid) => Effect.Effect<Array<Fid>, HubError>
    getFollowing: (fid: Fid) => Effect.Effect<Array<Fid>, HubError>
  }
>() {}
